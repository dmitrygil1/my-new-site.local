			...
			if ( is_author() ) {
				...
				<section class="ast-author-box ast-archive-description">
					<div class="ast-author-bio">
						...
						<span class="author-contact-info">
						<?php if(get_the_author_meta('facebook')) { ?>
							<a class="author_facebook_link" href="<?php echo get_the_author_meta( 'facebook' ); ?>">
								<img src="https://cdn-icons-png.flaticon.com/512/2175/2175193.png" alt="facebook icon" width="40" height="40">
							</a>
						<?php } ?> 
						
						<?php if(get_the_author_meta('instagram')) { ?>
							<a class="author_instagram_link" href="<?php echo get_the_author_meta( 'instagram' ); ?>">
								<img src="https://phonoteka.org/uploads/posts/2021-04/thumbs/1619185135_20-phonoteka_org-p-znachok-instagramm-bez-fona-22.png" alt="Instagram icon" width="50" height="50">
							</a>
						<?php } ?> 
						
						<?php if(get_the_author_meta('twitter')) { ?>
							<a class="author_twitter_link" href="<?php echo get_the_author_meta( 'twitter' ); ?>">
								<img src="https://cdn-icons-png.flaticon.com/512/733/733635.png" alt="twitter icon" width="40" height="40">
							</a>
						<?php } ?> 
						</span>	
