...
if ( selector.length > 0 ) {
	...
	if ( blockquote__tweet.length > 0 ) {
		...
		blockquote__tweet[0].addEventListener("click",function(){	
			var request_url = "https://twitter.com/share?url="+ encodeURIComponent("http://my-new-site.local/main-page")+"&text="+("You've landed on the best news site of your life (just kidding).<br>However, given that it was created in a couple of hours, you can estimate the approximate speed \/ quality of work")+"&via="+("");
